...
#define DECLARE_HACKY_NATIVE_ERROR(ClassName, snake_name, PrototypeName, ConstructorName) \
...
#define DECLARE_HACKY_NATIVE_ERROR_CONSTRUCTOR(ClassName, snake_name, PrototypeName, ConstructorName)          \
...
#define DECLARE_HACKY_NATIVE_ERROR_PROTOTYPE(ClassName, snake_name, PrototypeName, ConstructorName) \
    class PrototypeName final : public JS::PrototypeObject<PrototypeName, ClassName> {              \
        ...
        GC_DECLARE_ALLOCATOR(PrototypeName);                                                        \
                                                                                                    \
    public:                                                                                         \
        static PrototypeName& hacky_the(JS::Realm&);                                                \
        virtual void initialize(JS::Realm&) override;                                               \
    ...
    extern GC::Ptr<PrototypeName> g_##snake_name##_prototype_instance;

DECLARE_HACKY_NATIVE_ERROR_CONSTRUCTOR(CompilError, compile_error, CompileErrorPrototype, CompileErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR_CONSTRUCTOR(LinkError, link_error, LinkErrorPrototype, LinkErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR_CONSTRUCTOR(RuntimeError, runtime_error, RuntimeErrorPrototype, RuntimeErrorConstructor)

DECLARE_HACKY_NATIVE_ERROR(CompileError, compile_error, CompileErrorPrototype, CompileErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR(LinkError, link_error, LinkErrorPrototype, LinkErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR(RuntimeError, runtime_error, LinkErrorPrototype, LinkErrorConstructor)

DECLARE_HACKY_NATIVE_ERROR_PROTOTYPE(CompileError, compile_error, CompileErrorPrototype, CompileErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR_PROTOTYPE(LinkError, link_error, LinkErrorPrototype, LinkErrorConstructor)
DECLARE_HACKY_NATIVE_ERROR_PROTOTYPE(RuntimeError, runtime_error, RuntimeErrorPrototype, LinkErrorConstructor)

#undef DECLARE_HACKY_NATIVE_ERROR
#undef DECLARE_HACKY_NATIVE_ERROR_PROTOTYPE
#undef DECLARE_HACKY_NATIVE_ERROR_CONSTRUCTOR
}
