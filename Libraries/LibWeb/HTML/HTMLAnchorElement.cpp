...
static String get_the_suggested_filename(GC::Ref<Fetch::Infrastructure::Response> response, Page& page, Optional<DOM::Document&> document, Optional<String&> download_attribute)
{
...
static String handle_as_a_download(GC::Ref<Fetch::Infrastructure::Response> response, Page& page, Optional<DOM::Document&> document, Optional<String> download_attribute)
{
